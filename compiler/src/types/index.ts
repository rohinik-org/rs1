...
export type { ConsolePermission, ConsolePermissionPolicy, ExtensionPoint, ExtensionContribution, ExtensionDescriptor, ExtensionManifest, ExtensionState } from './console-extension-ir.js'
