...
| `67d7b40b619a238e` | `security/dry-run-signing.pub` | CI dry-run rehearsal (test only) | **ACTIVE** |
...
- Dry-run private key (`67d7b40b619a238e`) stored only in GitHub repository secret `ROHINIK_SIGN_KEY_TEST` in `rohinik-org/rs1`. Never committed.
