...
const emptyPlan: WorkflowPlan = {
  ...
  translationResult: { status: 'SUCCESS', translatorId: 'test', confidence: 1, intent: { intentId: 'i1', schemaVersion: '1.0', rawInput: 'test', concepts: [], preferredSkills: [], constraints: {}, translatedBy: 'test', translationConfidence: 1, unresolvedTerms: [] }, unresolvedTerms: [], warnings: [] },
