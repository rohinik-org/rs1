...
// ponytail: resolver returns null output — exercises engine with no real skills wired
...
export async function runFailureInvalidScenario(
  ...
  const engine = new ExecutionEngine(nullResolver, new SequentialExecutionScheduler(), new NullExecutionStore())
